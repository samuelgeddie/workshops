...
As part of its _Hands-on Workshop Series_, the **Chico Data Science Initiative** is pleased to provide this practical and applied session. _Preparing Data for Analysis_ is designed to assist everyone that analyzes data avoid (and/or resolve) frustrating problems unfortunately inherent in many datasets.
...
In this fast-paced Preparing Data for Analysis Workshop, you'll learn techniques to avoid-or remedy-frequently occurring problems found in many datasets; such as (how to avoid/remedy):

* Data Formatting ("Lexical") Problems,
* Meaning ("Semantic") Problems, and
* Structure ("Data Normalization") Problems.

Through practical exercises applied to each problem area (above), you'll learn how to create "Units-of-Analysis" pertinent to your data and desired analysis.
